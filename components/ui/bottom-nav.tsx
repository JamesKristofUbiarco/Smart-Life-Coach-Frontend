  ...
  return (
    ...
    >
      <div className="flex flex-row justify-around items-center bg-transparent w-full">
        ...
        <Link href="/explore" className="flex items-center relative bottom-1.5">
          {isPlanesActive ? (
            <Icon
        ...
        <Link href="/notifications" className="flex items-center relative bottom-1.5">
          {isTareasActive ? (
        ...
        <Link href="/messages" className="flex items-center relative bottom-1.5">
          {isPerfilActive ? (
